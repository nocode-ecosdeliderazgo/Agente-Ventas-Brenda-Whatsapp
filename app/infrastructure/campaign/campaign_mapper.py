"""
Mapeador de campañas para infraestructura.
"""
...
class CampaignMapper:
    ...
    def map_campaign_course(self, hashtags_info: Dict[str, Any]) -> Dict[str, Any]:
        """
        Mapea curso y campaña desde hashtags
        ...
        try:
            ...
            campaign_info = self._get_campaign_info(course_id, campaign_name)
    ...
    def _get_campaign_info(self, course_id: str, campaign_name: str) -> Dict[str, Any]:
